...
HD_PWD='C:/Users/kfranz/Desktop/steppermotorwithfpgainst/Stepper_Motor_Full_Step/Stepper_Motor_Full_Step.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_step_interface.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pmod_step_interface.tcl
