...
HD_PWD='C:/Users/kfranz/Desktop/steppermotorwithfpgainst/Stepper_Motor_Full_Step/Stepper_Motor_Full_Step.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_step_interface.vdi -applog -m64 -messageDb vivado.pb -mode batch -source pmod_step_interface.tcl -notrace
